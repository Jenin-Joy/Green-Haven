...
class tbl_complaint(models.Model):
   ...
   delivery = models.ForeignKey(tbl_delivery, on_delete=models.CASCADE,null=True)
...
class tbl_booking(models.Model):
    ...
    user = models.ForeignKey(tbl_user, on_delete=models.CASCADE)
    deliveryboy = models.ForeignKey(tbl_delivery, on_delete=models.CASCADE , null=True)
