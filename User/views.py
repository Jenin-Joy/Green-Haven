...
def designpayment(request, id):
     data = tbl_designrequest.objects.get(id=id)
     amount = data.designrequest_amount
     if request.method == 'POST':
          data.designrequest_status = 3
          data.save()
